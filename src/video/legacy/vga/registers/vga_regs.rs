...
pub const VGA_13H_CRT_CONTROL_REGS: [u16; 25] = [
    ...
    0x0D0A, 0x0E0B, 0x000C, 0x000D, 0x000E, 0x500F,
...
//-----------------------------------------------
//  *MODE X 320x200px 256 colors*
pub const VGA_320_200_X_MISC_OUTPUT_REG: u8 = 0x63;
pub const VGA_320_200_X_CRT_CONTROL_REGS: [u16; 25] = [
    0x5F00, //Horizontal total register (index 0x00)
    0x4F01, //Horizontal Display-Enable End Register (index 0x01)
    0x5002, //Start Horizontal Blanking Register (index 0x02)
    0x8203, //End Horizontal Blanking Register (index 0x03)
...
pub const VGA_320_200_X_SEQUENCER_REGS: [u16; 5] = [
...
pub const VGA_320_200_X_GRAPHICS_CONTROLLER_REGS: [u16; 9] = [
    0x0000, //Set/reset register (0x00)
    0x0001, //Enable set/reset register (0x01)
    0x0002, //Color compare register (0x02)
    0x0003, //Data rotate register (0x03)
...
pub const VGA_320_200_X_ATTRIBUTE_CONTROLLER_REGS: [u8; 21] = [
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
    0x41, 0x00, 0x0F, 0x00, 0x00,
];
//----------------------------------------
