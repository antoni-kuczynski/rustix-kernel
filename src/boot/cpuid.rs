...
impl CpuId {
    ...
    fn base() -> &'static CpuidResult {
        &CPU_ID
            .get()
            .expect("CpuId not initialized! Call cpuid_init() first.")
            .base
    }
    ...
    pub fn has_dtes64() -> bool {
        (Self::base().ecx & (1 << 2)) != 0
    }
    pub fn has_monitor() -> bool {
        (Self::base().ecx & (1 << 3)) != 0
    }
    pub fn has_ds_cpl() -> bool {
        (Self::base().ecx & (1 << 4)) != 0
    }
    pub fn has_vmx() -> bool {
        (Self::base().ecx & (1 << 5)) != 0
    ...
    pub fn has_cid() -> bool {
        (Self::base().ecx & (1 << 10)) != 0
    }
    pub fn has_sdbg() -> bool {
        (Self::base().ecx & (1 << 11)) != 0
    }
    pub fn has_fma() -> bool {
        (Self::base().ecx & (1 << 12)) != 0
    }
    pub fn has_cx16() -> bool {
        (Self::base().ecx & (1 << 13)) != 0
    }
    pub fn has_xtpr() -> bool {
        (Self::base().ecx & (1 << 14)) != 0
    }
    pub fn has_pdcm() -> bool {
        (Self::base().ecx & (1 << 15)) != 0
    }
    pub fn has_pcid() -> bool {
        (Self::base().ecx & (1 << 17)) != 0
    }
    pub fn has_dca() -> bool {
        (Self::base().ecx & (1 << 18)) != 0
    }
    pub fn has_sse4_1() -> bool {
        (Self::base().ecx & (1 << 19)) != 0
    }
    pub fn has_sse4_2() -> bool {
        (Self::base().ecx & (1 << 20)) != 0
    }
    pub fn has_x2apic() -> bool {
        (Self::base().ecx & (1 << 21)) != 0
    }
    pub fn has_movbe() -> bool {
        (Self::base().ecx & (1 << 22)) != 0
    }
    pub fn has_popcnt() -> bool {
        (Self::base().ecx & (1 << 23)) != 0
    }
    pub fn has_tsc_deadline() -> bool {
        (Self::base().ecx & (1 << 24)) != 0
    }
    pub fn has_aes() -> bool {
        (Self::base().ecx & (1 << 25)) != 0
    }
    pub fn has_xsave() -> bool {
        (Self::base().ecx & (1 << 26)) != 0
    }
    pub fn has_osxsave() -> bool {
        (Self::base().ecx & (1 << 27)) != 0
    }
    pub fn has_avx() -> bool {
        (Self::base().ecx & (1 << 28)) != 0
    }
    pub fn has_f16c() -> bool {
        (Self::base().ecx & (1 << 29)) != 0
    }
    pub fn has_rdrand() -> bool {
        (Self::base().ecx & (1 << 30)) != 0
    }
    pub fn has_hypervisor() -> bool {
        (Self::base().ecx & (1 << 31)) != 0
    }
    ...
    pub fn has_sep() -> bool {
        (Self::base().edx & (1 << 11)) != 0
    }
    pub fn has_mtrr() -> bool {
        (Self::base().edx & (1 << 12)) != 0
    }
    pub fn has_pge() -> bool {
        (Self::base().edx & (1 << 13)) != 0
    }
    pub fn has_mca() -> bool {
        (Self::base().edx & (1 << 14)) != 0
    }
    pub fn has_cmov() -> bool {
        (Self::base().edx & (1 << 15)) != 0
    }
    pub fn has_pat() -> bool {
        (Self::base().edx & (1 << 16)) != 0
    }
    pub fn has_pse36() -> bool {
        (Self::base().edx & (1 << 17)) != 0
    }
    pub fn has_psn() -> bool {
        (Self::base().edx & (1 << 18)) != 0
    }
    pub fn has_clflush() -> bool {
        (Self::base().edx & (1 << 19)) != 0
    }
    pub fn has_ds() -> bool {
        (Self::base().edx & (1 << 21)) != 0
    }
    pub fn has_acpi() -> bool {
        (Self::base().edx & (1 << 22)) != 0
    }
    pub fn has_mmx() -> bool {
        (Self::base().edx & (1 << 23)) != 0
    }
    pub fn has_fxsr() -> bool {
        (Self::base().edx & (1 << 24)) != 0
    }
    pub fn has_sse() -> bool {
        (Self::base().edx & (1 << 25)) != 0
    }
    pub fn has_sse2() -> bool {
        (Self::base().edx & (1 << 26)) != 0
    }
    pub fn has_ss() -> bool {
        (Self::base().edx & (1 << 27)) != 0
    }
    pub fn has_htt() -> bool {
        (Self::base().edx & (1 << 28)) != 0
    }
    pub fn has_tm() -> bool {
        (Self::base().edx & (1 << 29)) != 0
    }
    pub fn has_ia64() -> bool {
        (Self::base().edx & (1 << 30)) != 0
    }
    pub fn has_pbe() -> bool {
        (Self::base().edx & (1 << 31)) != 0
    }
